...
My name is Ulrik Strid, I'm a "full stack" developer from Sweden. Currently in a DevOps role working on everything from CI/CD and docker setup to backend and frontend services and up to architecture. I like open source and try to contribute where I can. My current focus on OSS has been to fill in gaps in web development using OCaml.
...
- Good knowledge of OpenID connect and related specs (JOSE, OAuth2)
  - I am one of 20 or so people to have built and certified a OpenID connect client.
